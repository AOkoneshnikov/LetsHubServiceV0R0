...
function dictValueParserTransferMoneyV0R0(): DictionaryValue<TransferMoneyV0R0> {
 ...
 type LetsHubV0R0_init_args = {
    $$type: 'LetsHubV0R0_init_args';
    currency: string;
}

function initLetsHubV0R0_init_args(src: LetsHubV0R0_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeStringRefTail(src.currency);
    };
...
async function LetsHubV0R0_init(currency: string) {
    const __code = Cell.fromBase64('');
    ...
    initLetsHubV0R0_init_args({ $$type: 'LetsHubV0R0_init_args', currency })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const LetsHubV0R0_errors: { [key: number]: { message: string } } = {
...
const LetsHubV0R0_types: ABIType[] = [
...
const LetsHubV0R0_getters: ABIGetter[] = [
    {"name":"data","arguments":[],"returnType":{"kind":"simple","type":"HubDataV0R0","optional":false}},
]

const LetsHubV0R0_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"empty"}},
    {"receiver":"internal","message":{"kind":"typed","type":"SetTrustlineV0R0"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]

export class LetsHubV0R0 implements Contract {
    
    static async init(currency: string) {
        return await LetsHubV0R0_init(currency);
    }
    
    static async fromInit(currency: string) {
        const init = await LetsHubV0R0_init(currency);
        const address = contractAddress(0, init);
        return new LetsHubV0R0(address, init);
    }
    
    static fromAddress(address: Address) {
        return new LetsHubV0R0(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  LetsHubV0R0_types,
        getters: LetsHubV0R0_getters,
        receivers: LetsHubV0R0_receivers,
        errors: LetsHubV0R0_errors,
    };
    ...
    async getData(provider: ContractProvider) {
        ...
        const result = loadTupleHubDataV0R0(source);
        return result;
    }
